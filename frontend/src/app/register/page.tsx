        ...
        <div className="w-full max-w-md glass rounded-2xl p-6 sm:p-8 border border-border relative shadow-xl space-y-6 fade-in">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-xs font-semibold text-muted-foreground">{t('registerRoleLabel')}</label>
              ...
              {errors.role && (
                <span className="text-xs text-danger font-medium">{errors.role.message}</span>
              )}
            </div>
